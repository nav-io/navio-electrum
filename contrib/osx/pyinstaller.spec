...
PACKAGE_NAME='NavioElectrum.app'
PYPKG='electrum'
...
app = BUNDLE(
    ...
    info_plist={
        ...
        'CFBundleURLTypes':
            [{
                'CFBundleURLName': 'navio',
                'CFBundleURLSchemes': ['navio', 'lightning', 'lnurlp', 'lnurlw', ],
            }],
        'LSMinimumSystemVersion': '11',
        'NSCameraUsageDescription': 'Navio Electrum would like to access the camera to scan for QR codes',
    },
)
